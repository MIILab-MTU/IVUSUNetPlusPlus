...
def get_generator(args, image_size=512):
    ...
    # print("[x] found %d patients" % len(patients))
    # train_patients, val_patients = get_split_deterministic(patients, fold=args.cv, num_splits=args.cv_max, random_state=11000)
    train_patients = get_list_of_patients("{}/{}/train".format(args.data_path,args.cv))
    dataloader_train = VesselDataLoader("{}/{}/train".format(args.data_path,args.cv), train_patients, args.batch_size, image_size, 1)
